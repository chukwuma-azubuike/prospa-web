    ...
    render() {
        ...
        return (
            <div style={{
                ...
                <p style={{ fontSize: '12px', marginBottom: '15px' }} >{this.props.accountType}</p>
                <p style={{ fontSize: '11px', color: '#8397AB', marginBottom: '20px' }} >{this.props.bankAccount}</p>
                ...
                <img style={{ position: 'absolute', top: '30px', marginLeft: '380px', width: '44px' }} src={this.props.icon} ></img>
            </div>
        );
    }
}
