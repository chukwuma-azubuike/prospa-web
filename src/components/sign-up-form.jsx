...
function SignUpForm() {
    ...
    return (
        <div>
            ...
            {isTabletOrMobile &&
                <div style={{ margin: '40px auto', width: '80%', height: '100px' }}>
                    <p style={{ fontSize: '10px', margin: 'auto' }} >Already a member?
                        <Link to="/signin" href='' style={{ textDecoration: 'none', color: '#FA4A84' }} >  Sign In</Link></p>
                    <form id='sign-up-form-resp' className='sign-up-form' >
                        <h1>Create your account</h1>
                        <p style={{ color: '#8397AB', fontSize: '14px', fontWeight: '100' }} >A short description about account types</p>
                        <div>
                            <input type='text' name='fName' class='FN-res' placeholder='First name' />
                            {/* <span class="floating-label-res">First name</span> */}
                            <input type='text' name='lName' class='LN-res' placeholder='Last name' />
                            {/* <span class="floating-label-res-LN">Last name</span> */}
                            <select placeholder='Country' name="countryCode" id="">
                                <option data-countryCode="NG" value="234" Selected>+234</option>
                                <option data-countryCode="GB" value="44">UK +44</option>
                                <option data-countryCode="US" value="1">USA +1</option>
                            ...
                            <input name='phone' class='MN-res' style={{ width: '61.2%', marginLeft: '3%' }} type='text' placeholder='Mobile Number' />
                            {/* <span class="floating-label-res-MN">Mobile number</span> */}
                            <input name='email' class='EA-res' type='email' placeholder='Email' />
                            {/* <span class="floating-label-res-EA">Email Address</span> */}
                        </div>
                    ...
                    <div style={{
                        ...
                        color: '#FFFFFF', background: '#7E51FF', marginTop: '30px',
                    }} >
