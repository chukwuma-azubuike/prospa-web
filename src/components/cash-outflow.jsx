        ...
        <div>
            ...
            {isTabletOrMobile &&
                <div style={{
                    ...
                    <p style={{ fontSize: '14px', marginBottom: '15px' }} >Cash outflow</p>
                    <div style={{ marginRight: '10%', padding: '20px 0', width: '100%', alignItems: 'center', display: 'flex' }} >
                        <span> <img style={{ width: '35px' }} src={pink} /> </span>
                        <span style={{ fontSize: '12px', margin: 'auto 8% auto 3%', color: '#8397AB' }} >Banking Fees</span>
                        <div style={{ position: 'absolute', right: '0' }} >
                            <p>- N 250,000</p>
                            <div style={{
                                width: '140%', height: '6px', background: '#EEEFF7',
                                borderRadius: '4px', position: 'relative'
                            }} >
                            </div>
                            <div style={{
                                width: '115%', height: '6px', background: '#FFCF56',
                                borderRadius: '4px', position: 'relative', bottom: '6px'
                            }} >
                            </div>
                        </div>
                    </div>
                    <div style={{ marginRight: '10%', padding: '20px 0', width: '100%', alignItems: 'center', display: 'flex' }} >
                        <span> <img style={{ width: '35px' }} src={teal} /> </span>
                        <span style={{ fontSize: '12px', margin: 'auto 8% auto 3%', color: '#8397AB' }} >Internet</span>
                        <div style={{ position: 'absolute', right: '0' }} >
                            <p>- N 250,000</p>
                            <div style={{
                                width: '140%', height: '6px', background: '#EEEFF7',
                            ...
                            <div style={{
                                width: '90%', height: '6px', background: '#FFCF56',
                                borderRadius: '4px', position: 'relative', bottom: '6px'
                            }} >
                            </div>
                        </div>
                    ...
                    <div style={{ marginRight: '10%', padding: '20px 0', width: '100%', alignItems: 'center', display: 'flex' }} >
                        <span> <img style={{ width: '35px' }} src={purple} /> </span>
                        <span style={{ fontSize: '12px', margin: 'auto 8% auto 3%', color: '#8397AB' }} >Marketing</span>
                        <div style={{ position: 'absolute', right: '0' }} >
                            <p>- N 250,000</p>
                            <div style={{
                                width: '140%', height: '6px', background: '#EEEFF7',
                            ...
                            <div style={{
                                width: '65%', height: '6px', background: '#FFCF56',
                                borderRadius: '4px', position: 'relative', bottom: '6px'
                            }} >
                            </div>
                        </div>
                    ...
                    <div style={{ marginRight: '10%', padding: '20px 0', width: '100%', alignItems: 'center', display: 'flex' }} >
                        <span> <img style={{ width: '35px' }} src={green} /> </span>
                        <span style={{ fontSize: '12px', margin: 'auto 8% auto 3%', color: '#8397AB' }} >Transfer</span>
                        <div style={{ position: 'absolute', right: '0' }} >
                            <p>- N 250,000</p>
                            <div style={{
                                width: '140%', height: '6px', background: '#EEEFF7',
                            ...
                            <div style={{
                                width: '35%', height: '6px', background: '#FFCF56',
                                borderRadius: '4px', position: 'relative', bottom: '6px'
                            }} >
                            </div>
                        </div>
